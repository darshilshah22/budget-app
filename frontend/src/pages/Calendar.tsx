  ...
  return (
    <div className="space-y-8 p-8 animate-fade-in">
      ...
      <div className="flex justify-between items-center mb-10">
        <div>
          <h1 className="text-4xl font-bold bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">Calendar</h1>
          <p className="text-gray-400 mt-3 text-lg">Track your financial events and transactions.</p>
        </div>
        <motion.button
              ...
              {day && (
                <>
                  ...
                  <div className="space-y-1">
                    {getEventsForDate(new Date(selectedDate.getFullYear(), selectedDate.getMonth(), day)).map((event) => (
                      <motion.div
                        key={event.id}
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <span className={`text-lg font-medium ${
                    selectedEvent.type === 'income' ? 'text-green-400' : 'text-red-400'
                  }`}>
